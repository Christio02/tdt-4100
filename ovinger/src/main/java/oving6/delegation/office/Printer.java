...
public class Printer {
    ...
    public void printDocument(String document, Employee employee) {
        ...
        ArrayList<String> newList= new ArrayList<>(); // initzialising new list that keeps track of 
    ...
    public List<String> getPrintHistory(Employee employee) {
        ...
        return this.totalTasks.get(employee); // returns list of all documents printed by employee;
